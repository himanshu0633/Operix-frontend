...
export default function InvoicePage() {
  return (
    <AdminShell activePage="orders">
      <section className="content invoiceContent">
        <header className="orderPageHeader">
          <div>
            <a className="plainBack" href="/admin/orders"><ArrowLeft size={16} />Back</a>
        ...
        <div className="invoiceGrid">
          ...
          <main>
            ...
            <section className="invoicePaper">
              <header className="paperHeader">
                <div><span className="paperIcon">▣</span><strong>Shah Enterprises</strong><p>27AABCS1234M1ZK</p><p>12, Commercial Complex, Mumbai 400001</p></div>
                <div><h2>INVOICE</h2><strong># INV-2026-0142</strong><p>Date: 22 May 2026</p><p>Due: 22 Jun 2026</p></div>
              </header>
